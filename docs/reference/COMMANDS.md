...
| `/events discover` | | Reads Hacker Tracker now and queues unknown cons for review; reports fetched, new, linked, mismatches, skipped. | moderators |
| `/events status` | | Config, counts, next post and sweep, missing roles, discovery on or off, and whether the bot may mention roles and post embeds in the events and review channels. | moderators |

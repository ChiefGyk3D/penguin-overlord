...
ExecStart=/usr/bin/docker run -d --name penguin-overlord --restart unless-stopped --log-driver json-file --log-opt max-size=20m --log-opt max-file=5 --env-file $PROJECT_DIR/.env -v $PROJECT_DIR/data:/app/data $IMAGE_NAME
